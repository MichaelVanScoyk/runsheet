...
# INSTRUCTIONS:
# 1. Open reports.py
# 2. Find the function: @router.get("/html/incident/{incident_id}")
# 3. Delete everything from that decorator until (but not including):
...
async def get_incident_html_report(
    ...
    # ==========================================================================
    # BUILD PERSONNEL ASSIGNMENTS - Query incident_units/incident_personnel
    # ==========================================================================
